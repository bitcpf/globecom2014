...
%
While the intention of wireless mesh networks was to provide a large-scale solution for Internet 
connectivity, even the densest urban areas were not able to broadly leverage mesh in metropolitan areas.
Ultimately, the small spatial separation required for effective 802.11 links in these areas resulted in 
prohibitively large up-front costs. The FCC has reapportioned spectrum from TV white spaces for the purposes
of large-scale Internet connectivity via wireless topologies of all kinds, including mesh networks.
...
range of spectrum across diverse population densities becomes a critical issue for the deployment of mesh 
networks.  In this paper, we measure the spectrum utility in the Dallas-Fort Worth metropolitan and surrounding
...
mesh networks with white space bands reduce the number of access points up to 1650\% in sparse
rural areas over similar WiFi-only solutions. In more populated rural areas and sparse urban areas, we 
find a mesh node reduction of 660\% and 412\%, respectively.  However, due to the heavy use of white
space bands in dense urban areas, the cost reductions invert (an increase in required mesh nodes 
