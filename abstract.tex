...
% What we did
% Gains
In this paper, we model the heterogeneous white space and WiFi deployment problem
. propose a relaxed ILP to get the lower bound of the amount of access point 
under resource limitations and a heuristic approach of the problem. In particular,
we map the problem as a Bin packing problem and resolve it with a fixme method.
In doing so, we find that networks with white space bands reduce the number 
of a cess points up to fixme  
\end{abstract}
